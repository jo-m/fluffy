      ...
      - name: "Apps"
        ...
        items:
          - name: "Kitchenowl"
            ...
            url: "https://kitchen.${tld}.net/"
            target: "_blank"
          - name: "Readeck"
            subtitle: "Bookmarks"
            icon: "fas fa-bookmark"
            url: "https://readeck.${tld}.net/"
            target: "_blank"
          - name: "Traggo"
            subtitle: "Time Tracking"
            icon: "fas fa-stopwatch"
            url: "https://track.${tld}.net/"
            target: "_blank"
          - name: "Syncthing GUI"
            icon: "fas fa-rotate"
            url: "https://sync.${tld}.net/"
            target: "_blank"
      - name: "Utilities"
        icon: "fas fa-toolbox"
        items:
          - name: "Ferrishare"
            ...
            url: "https://files.${tld}.net/"
            target: "_blank"
          - name: "Hemmelig"
            subtitle: "Secrets Sharing"
            icon: "fas fa-square-arrow-up-right"
            url: "https://secrets.${tld}.net/"
            target: "_blank"
          - name: "QR"
            subtitle: "Generate QR Codes"
            icon: "fas fa-qrcode"
            url: "https://qr.${tld}.net/"
            target: "_blank"
      - name: "Infrastructure"
        ...
        items:
          - name: "Openobserve"
            ...
            url: "https://monitor.${tld}.net/"
            target: "_blank"
          - name: "Echo"
            subtitle: "HTTP Connection Info"
            icon: "fas fa-network-wired"
            url: "https://echo.${tld}.net/"
            target: "_blank"
  '';
in {
